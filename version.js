...
// orden-servicio.html, remito-ingreso.html, ficha-equipo.html) para
// que exista un solo número de versión que sincronizar en cada
// actualización, en vez de repetirlo en cada archivo.
//
...
const PORTAL_TLC_VERSION = "2026.07.22.4";
